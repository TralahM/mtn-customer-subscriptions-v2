...
from mtn_customer_subscriptions_v2 import (
    APIResponseValidationError,
    MtnCustomerSubscriptionsV2,
    AsyncMtnCustomerSubscriptionsV2,
)
from mtn_customer_subscriptions_v2._types import Omit
from mtn_customer_subscriptions_v2._models import BaseModel, FinalRequestOptions
from mtn_customer_subscriptions_v2._constants import RAW_RESPONSE_HEADER
from mtn_customer_subscriptions_v2._exceptions import (
    APIStatusError,
    APITimeoutError,
    APIResponseValidationError,
    MtnCustomerSubscriptionsV2Error,
)
from mtn_customer_subscriptions_v2._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MtnCustomerSubscriptionsV2 | AsyncMtnCustomerSubscriptionsV2) -> int:
...
class TestMtnCustomerSubscriptionsV2:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mtn_customer_subscriptions_v2/_legacy_response.py",
                        "mtn_customer_subscriptions_v2/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mtn_customer_subscriptions_v2/_compat.py",
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = MtnCustomerSubscriptionsV2(
            base_url=base_url,
            api_key=api_key,
            access_token=access_token,
            _strict_response_validation=True,
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MtnCustomerSubscriptionsV2Error):
            with update_env(**{"X_API_KEY": Omit()}):
                client2 = MtnCustomerSubscriptionsV2(
                    base_url=base_url, api_key=None, access_token=access_token, _strict_response_validation=True
                )
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: MtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MTN_CUSTOMER_SUBSCRIPTIONS_V2_BASE_URL="http://localhost:5000/from/env"):
            client = MtnCustomerSubscriptionsV2(
                api_key=api_key, access_token=access_token, _strict_response_validation=True
            )
    ...
    def test_base_url_trailing_slash(self, client: MtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MtnCustomerSubscriptionsV2(
            base_url=base_url, api_key=api_key, access_token=access_token, _strict_response_validation=True
        )
    ...
    @mock.patch("mtn_customer_subscriptions_v2._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/customers/customerId/subscriptions").mock(
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/customers/customerId/subscriptions").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/customers/customerId/subscriptions").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: MtnCustomerSubscriptionsV2, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMtnCustomerSubscriptionsV2:
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncMtnCustomerSubscriptionsV2(
            base_url=base_url,
            api_key=api_key,
            access_token=access_token,
            _strict_response_validation=True,
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMtnCustomerSubscriptionsV2) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncMtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMtnCustomerSubscriptionsV2) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMtnCustomerSubscriptionsV2(
            base_url=base_url, api_key=api_key, access_token=access_token, _strict_response_validation=True
        )
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncMtnCustomerSubscriptionsV2,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.customers.subscriptions.with_raw_response.create(
            customer_id="customerId",
            subscription_id="subscriptionId",
            subscription_name="subscriptionName",
            subscription_provider_id="subscriptionProviderId",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMtnCustomerSubscriptionsV2, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from mtn_customer_subscriptions_v2._utils import asyncify
        from mtn_customer_subscriptions_v2._base_client import get_platform 
