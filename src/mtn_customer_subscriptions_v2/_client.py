...
class MtnCustomerSubscriptionsV2(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous mtn-customer-subscriptions-v2 client instance.
        ...
        if api_key is None:
            raise MtnCustomerSubscriptionsV2Error(
        ...
        if access_token is None:
            raise MtnCustomerSubscriptionsV2Error(
                "The access_token client option must be set either by passing access_token to the client or by setting the OAUTH2_ACCESS_TOKEN environment variable"
            )
        self.access_token = access_token

        if base_url is None:
            base_url = os.environ.get("MTN_CUSTOMER_SUBSCRIPTIONS_V2_BASE_URL")
        if base_url is None:
            base_url = f"https://api.mtn.com/v2"
...
class AsyncMtnCustomerSubscriptionsV2(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async mtn-customer-subscriptions-v2 client instance.
...
AsyncClient = AsyncMtnCustomerSubscriptionsV2
